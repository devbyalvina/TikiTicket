...
class MakeBookingUseCaseTest {
    ...
    fun `예매에 성공한다`() {
        ...
        val expectedBooking = Booking(1, BookingStatusType.BOOKED, LocalDateTime.now().plusMinutes(5), concertId, "Concert", "Artist", LocalDateTime.now(), "Venue", seatNo, 10000L, null, LocalDateTime.now(), LocalDateTime.now())
